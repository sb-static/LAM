...
def demo_lam(flametracking, lam, cfg):
    ...
    def core_fn(image_path: str, video_params, working_dir, enable_oac_file):
        ...
        if enable_oac_file:
            try:
                from tools.generateARKITGLBWithBlender_5k import generate_glb
                ...
                generate_glb(
                    ...
                    template_fbx=Path("./assets/sample_oac/template_file_5k.fbx"),
...
def launch_gradio_app():
    ...
    os.environ.update({
        ...
        'APP_INFER': './configs/inference/lam-5k-8gpu.yaml',
        'APP_TYPE': 'infer.lam',
